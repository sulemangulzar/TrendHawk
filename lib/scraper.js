 ...
 * Scrapes products from a platform (used by search API)
 */
export async function scrapeProducts(keyword, platform) {
  console.log(`[Scraper] Legacy scrapeProducts called for: ${keyword} on ${platform}`);

  // This is a placeholder for the old scraping logic
  // Return empty array as the new system uses analyzeProduct instead
  return [];
}
