...
const Button = React.forwardRef(({ className, variant = "default", size = "default", ...props }, ref) => {
    ...
    const variants = {
        default: "bg-indigo-500 text-white hover:bg-indigo-600 shadow-lg shadow-indigo-500/20 dark:bg-indigo-600 dark:hover:bg-indigo-700",
        destructive: "bg-red-500 text-white hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700",
        outline: "border-2 border-indigo-500 dark:border-indigo-600 bg-transparent text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20",
